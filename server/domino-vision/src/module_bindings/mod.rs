...
pub mod update_score_reducer;
pub mod update_user_name_reducer;
pub mod user_table;
pub mod user_type;
...
pub use remove_player_reducer::remove_player;
pub use update_score_reducer::update_score;
pub use update_user_name_reducer::update_user_name;
pub use user_table::*;
...
pub enum Reducer {
    CreateLobby { user_name: String, code_arg: String },
    JoinLobby { name: String, code: String },
    RemovePlayer { player_id: u64 },
    UpdateScore { player_id: u64, new_score: i32 },
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            ...
            Reducer::UpdateScore { .. } => "update_score",
            Reducer::UpdateUserName { .. } => "update_user_name",
            _ => unreachable!(),
        }
    }
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::CreateLobby {
                ...
                code_arg: code_arg.clone(),
            }),
            Reducer::JoinLobby { name, code } => {
                __sats::bsatn::to_vec(&join_lobby_reducer::JoinLobbyArgs {
                    name: name.clone(),
                    code: code.clone(),
                })
            }
            Reducer::RemovePlayer { player_id } => {
                __sats::bsatn::to_vec(&remove_player_reducer::RemovePlayerArgs {
            ...
            Reducer::UpdateScore {
                player_id,
                new_score,
            } => __sats::bsatn::to_vec(&update_score_reducer::UpdateScoreArgs {
                player_id: player_id.clone(),
                new_score: new_score.clone(),
            }),
            Reducer::UpdateUserName { name } => {
                __sats::bsatn::to_vec(&update_user_name_reducer::UpdateUserNameArgs {
                    name: name.clone(),
                })
            }
            _ => unreachable!(),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.lobby = cache
            ...
            .with_updates_by_pk(|row| &row.lobby_code);
        diff.player = cache
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    const ALL_TABLE_NAMES: &'static [&'static str] = &["lobby", "player", "user"];
}
