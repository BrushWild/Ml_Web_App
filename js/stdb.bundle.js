...
// js/stdb/remove_player_reducer.ts
var remove_player_reducer_default = {
  playerId: t.u64()
};
...
// js/stdb/update_user_name_reducer.ts
var update_user_name_reducer_default = {
  name: t.string()
};
...
var tablesSchema = schema({
  lobby: table({
    name: "lobby",
    indexes: [
      { accessor: "lobby_code", name: "lobby_lobby_code_idx_btree", algorithm: "btree", columns: [
        "lobbyCode"
      ] }
    ],
    constraints: [
      { name: "lobby_lobby_code_key", constraint: "unique", columns: ["lobbyCode"] }
    ]
  }, lobby_table_default),
  player: table({
    name: "player",
    indexes: [
      { accessor: "lobby_code", name: "player_lobby_code_idx_btree", algorithm: "btree", columns: [
        "lobbyCode"
      ] },
